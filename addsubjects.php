...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="EnterSubject">
            ...
            <option value="5"> Genie Informatique I Year ( Semester V )</option>
            <option value="6"> Genie Informatique I Year ( Semester VI )</option>
            <option value="7"> Genie Informatique II Year ( Semester VII )</option>
            <option value="8"> Genie Informatique II Year ( Semester VIII )</option>
            <option value="9"> Genie Informatique III Year ( Semester IX )</option>
            <option value="10"> Genie Informatique III Year ( Semester X )</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="subjectdepartment" name="SD">
                            <option selected disabled>Select</option>
                            <option value="Informatique,Logistique et Mathematique">Informatique,Logistique et Mathematique</option>
                            <option value="Géne Electrique , Réseaux et Systèmes de Telecommunication">Géne Electrique , Réseaux et Systèmes de Telecommunication</option>
...
<div>
    ...
    <table id=subjectstable style="margin-left: 90px">
        ...
        $q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"),
            "SELECT * FROM module ORDER BY id_module ASC ");
