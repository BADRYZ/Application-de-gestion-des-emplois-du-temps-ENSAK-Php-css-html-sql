...
$query = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"), "SELECT * FROM professeur WHERE id_prof = '$whose'");
$row = mysqli_fetch_assoc($query);
$whose_name = $row['name'];
$query = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"), "SELECT * FROM professeur WHERE id_prof = '$sub'");
$row = mysqli_fetch_assoc($query);
$sub_name = $row['name'];
